...
public:
    ...
    //pre: none
    //post: will simplify the fraction after you add and multiply
    void reduce();
    //pre none
    //post: modifies the rational called on adds the first and second fraction together
...
// pre: none
//post: returns if two fractions are equal to other or not
